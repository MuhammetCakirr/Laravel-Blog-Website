			...
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					<div class="row g-0 align-items-center">
						<div class="col-2">
							<a href="{{ url('/') }}" class="logo m-0 float-start">Macellan Blog<span
						...
						<div class="col-2 text-end">
							<div class="user-info d-inline-block d-lg-inline-block">
								<span class="bi bi-person-circle"></span>
								@if (Auth::check())
								 <a style="color: white;" href="{{ route('Settings') }}">{{ Auth::user()->fname ." " .Auth::user()->lname  }}</a>	
								@else
									<a style="color: white;" href="{{ route('Login') }}">Giriş Yap</a>
								@endif
							</div>
						</div>
					</div>
